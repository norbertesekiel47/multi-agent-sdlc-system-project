...
class TestReport(BaseModel):
    ...
    generated_test_contents: dict[str, str] = Field(
        default_factory=dict,
        description="Map of test file path → content for sandbox_write_file. "
        "Populated when chat_with_cache path is used (no tool access). "
        "Keys must match entries in generated_test_files.",
    )
